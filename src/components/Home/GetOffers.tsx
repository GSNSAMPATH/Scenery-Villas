...
//         {/* Left - Image */}
//         <div className="mt-12 w-full md:w-full aspect-[4/3] bg-white border border-white rounded-2xl shadow-lg overflow-hidden transform transition duration-500 hover:-translate-y-2 hover:shadow-2xl hover:scale-105 relative">
//           <Image
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center  text-center px-6 `">
        ...
        >
          ...
          the hustle and bustle, providing a tranquil escape for those seeking
