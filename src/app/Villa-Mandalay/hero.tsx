...
export default function Hero() {
  return (
    <section className="bg-white relative w-full h-[700px] md:h-screen overflow-hidden">
      ...
      >
        <source
          src="https://res.cloudinary.com/diatamf9x/video/upload/f_auto,q_auto,w_1280,h_720,c_fill/v1755283669/Best_family_villa_in_Sri_Lanka_Villa_Mandalay_by_Scenery_Villas_Warm_Cozy_Paradise_Bentota_-_Scenery_Villas_Sri_Lanka_1080p_h264_rnyh6y.mp4"
          type="video/mp4"
        />
